...
In testing, you use special credit card numbers, amounts, and other codes to simulate successful/failing transactions.  Reference here: https://stripe.com/docs/testing
